        ...
        {programs.map((program) => {
          ...
          return (
            <button
              ...
              className={`block w-full overflow-hidden rounded-2xl border text-left transition-colors active:scale-[0.99] ${
                isActive
                  ? "border-text-primary bg-bg-card"
                  : "border-border-card bg-bg-card active:border-border active:bg-bg-input"
              }`}
            >
