...
- **Gym equipment curation** — configure your gym's available machines and free weights, then auto-build an optimal workout for each lift focus (Push/Pull/Legs & Abs). "Try Another Split" shuffles the selection for variety. Locked after first logged set to protect data
