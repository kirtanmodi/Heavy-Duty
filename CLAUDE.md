...
│   ├── rollingSchedule.ts # Rolling program cycle: history-aware projection that interleaves logged days with planned days, non-lift type matching
