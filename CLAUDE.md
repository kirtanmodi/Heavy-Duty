...
│   ├── rollingSchedule.ts # Rolling program cycle: history-aware projection that interleaves logged days with planned days
...
├── pages/
│   ├── Home.tsx            # Suggested hero + "Other Options" grid (all day types), "Done for Today" card, interactive calendar, stats grid, muscle recovery card, rest day suggestions, resume banner, full-state backup/export
...
|------|-----------|-------|
| `/` | Home | Suggested hero + "Other Options" grid (all day types), "Done for Today" card, interactive calendar (tap to log/undo/move, future rings from rolling cycle), stats, muscle recovery, rest day suggestions, full-state backup/export, resume banner |
